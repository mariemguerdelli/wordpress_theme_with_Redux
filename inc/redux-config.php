...
$opt_name = 'redux_theme';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$args = array(
	...
	'page_title'                => esc_html__( 'Redux Options', 'your-textdomain-here' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'header Fields', 'your-textdomain-here'),
		'id'               => 'header',
		'desc'             => esc_html__( 'These are really Header fields!', 'your-textdomain-here' ),
	...
	$opt_name,
	array(
		'title'            => esc_html__( 'The Header', 'your-textdomain-here' ),
		'desc'             => esc_html__( 'Here you can put in all your header details'),
		'id'               => 'header-text',
		'subsection'       => true,
		...
		'fields'           => array(
			array(
				...
				'desc'     => esc_html__( 'Put in your E-mail', 'your-textdomain-here' ),
				'default'  => ' info@markups.io',
			),
			array(
				'id'       => 'text-phone',
				'type'     => 'text',
				'title'    => esc_html__( 'Phone', 'your-textdomain-here' ),
				'desc'     => esc_html__( 'Put in your number', 'your-textdomain-here' ),
				'default'  => '(568) 986 652',
			),
			array(
				'id'       => 'header_facebook',
				...
				'desc'     => esc_html__( 'Put in your Facebook link, If you dont have facebook leave it empty', 'your-textdomain-here' ),
				'default'  => '#',
			),
			array(
				'id'       => 'header_twitter',
				...
				'desc'     => esc_html__( 'Put in your Twitter link, If you dont have twitter leave it empty', 'your-textdomain-here' ),
				'default'  => '#',
			),
			array(
				'id'       => 'header_google',
				...
				'desc'     => esc_html__( 'Put in your Google link, If you dont have google plus leave it empty', 'your-textdomain-here' ),
				'default'  => '#',
			),
			array(
				'id'       => 'header_linked',
				...
				'desc'     => esc_html__( 'Put in your LinkedIn link, If you dont have linkedin leave it empty', 'your-textdomain-here' ),
				'default'  => '#',
			),
			array(
				'id'       => 'header_youtube',
				'type'     => 'text',
				'title'    => esc_html__( 'Youtube', 'your-textdomain-here' ),
				'desc'     => esc_html__( 'Put in your Youtube link, If you dont have youtube leave it empty', 'your-textdomain-here' ),
				'default'  => '#',
			),
		)
));
	...
	$opt_name,
	array(
		'title'            => esc_html__( 'The Footer', 'your-textdomain-here' ),
		'desc'             => esc_html__( 'Here you can put in all your footer details'),
		'id'               => 'footer-text',
		'subsection'       => true,
		'customizer_width' => '700px',
		'fields'           => array(
			array(
				'id'       => 'text-contact',
				'type'     => 'text',
				'title'    => esc_html__( 'Contact', 'your-textdomain-here' ),
				'desc'     => esc_html__( 'Put in your contact form shortcode', 'your-textdomain-here' ),
				'default'  => ' info@markups.io',
			),
			array(
				'id'       => 'footer_street',
				...
				'desc'     => esc_html__( 'Put in your address', 'your-textdomain-here' ),
				'default'  => 'P.O. Box 320, Ross, California 9495, USA',
			),
			array(
				'id'       => 'footer_phone',
				'type'     => 'text',
				'title'    => esc_html__( 'Phone', 'your-textdomain-here' ),
				'desc'     => esc_html__( 'Put in your Number', 'your-textdomain-here' ),
				'default'  => '(415) 453-1568',
			),
			array(
				'id'       => 'footer_website',
				'type'     => 'text',
				'title'    => esc_html__( 'website', 'your-textdomain-here' ),
				'desc'     => esc_html__( 'Put in your Website', 'your-textdomain-here' ),
				'default'  => 'www.markups.io',
			),
			array(
				'id'       => 'footer_email',
				'type'     => 'text',
				'title'    => esc_html__( 'Email', 'your-textdomain-here' ),
				'desc'     => esc_html__( 'Put in your Email link', 'your-textdomain-here' ),
				'default'  => 'info@markups.io',
			),
	...
	$opt_name,
	array(
		'title'            => esc_html__( 'Contact Section', 'your-textdomain-here' ),
		'desc'             => esc_html__( 'Here you can put in all your footer details'),
		'id'               => 'footer-text-2',
		'subsection'       => true,
		'customizer_width' => '700px',
	...
	$opt_name,
	array(
		'title'            => esc_html__( 'Contact Section2', 'your-textdomain-here' ),
		'desc'             => esc_html__( 'Here you can put in all your footer details'),
		'id'               => 'footer-text-3',
		'subsection'       => true,
		'customizer_width' => '700px',
		'fields'           => array(
			array(
				'id'       => 'text-bottom',
				'type'     => 'text',
				'title'    => esc_html__( 'All rights reserved', 'your-textdomain-here' ),
				'desc'     => esc_html__( 'Put in your text or leave it empty', 'your-textdomain-here' ),
	...
	array(
		...
		'desc'       => esc_html__( 'Upload your logo'),
		'subsection' => true,
		'fields'     => array(
			...
			array(
				'id'       => 'switch-parent-1',
				'type'     => 'switch',
				'title'    => esc_html__( 'Logo switcher', 'your-textdomain-here' ),
				'subtitle' => esc_html__( 'You can upload your logo', 'your-textdomain-here' ),
				'default'  => false,
				'on'       => 'Enabled',
				'off'      => 'Disabled',
			),
			array(
				...
				'type'         => 'media',
				'url'          => true,
				'title'        => esc_html__( 'Logo upload', 'your-textdomain-here' ),
				'compiler'     => 'true',
				'desc'         => esc_html__( 'Here you can upload your logo.', 'your-textdomain-here' ),
				'subtitle'     => esc_html__( 'Upload any media using the WordPress native uploader', 'your-textdomain-here' ),
				'required' => array( 'switch-parent-1', '=', true ),
				'preview_size' => 'full',
			),
			array(
				'id'       => 'text-icon',
				'type'     => 'text',
				'title'    => esc_html__( 'The icon for the logo', 'your-textdomain-here' ),
				'desc'     => esc_html__( 'Put in your text or leave it empty', 'your-textdomain-here' ),
				'required' => array( 'switch-parent-1', '=', false ),
				'default'  => 'fa fa-university',
			),
			array(
				'id'       => 'text-logo',
				'type'     => 'text',
				'title'    => esc_html__( 'The logo text', 'your-textdomain-here' ),
				'desc'     => esc_html__( 'Put in your text or leave it empty', 'your-textdomain-here' ),
				'required' => array( 'switch-parent-1', '=', false ),
				'default'  => 'Varisity',
			),
